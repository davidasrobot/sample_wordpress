...
function twentytwenty_register_styles() {
	...
	wp_enqueue_style( 'fontawesome-free', get_template_directory_uri() . '/fontawesome-free/css/all.min.css', null, $theme_version, 'fontawesome' );
	// wp_enqueue_style( 'style', get_template_directory_uri() . '/style.css', null, $theme_version, 'custom' );
